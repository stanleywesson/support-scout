...
const { supportAgents, loading } = storeToRefs(ticketsStore)
...
const ticket = computed(() => ticketsStore.tickets.find((x) => x.id === ticketId))

const assignAgent = (event: Event) => {
...
<template>
  <div class="p-4 sm:p-6">
    ...
    <!-- Loading-->
    <div v-if="loading && !ticket" class="text-center p-8">
      <h2 class="text-2xl font-bold text-gray-800">Loading ticket...</h2>
    </div>
